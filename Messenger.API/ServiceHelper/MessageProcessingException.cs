namespace Messenger.API.ServiceHelper
{
    ...
    public class MessageProcessingException : Exception
    {
        ...
        public MessageProcessingException(string message, long userId, long groupId, string groupType)
            : base(message)
        {
            UserId = userId;
            GroupId = groupId;
        ...
        public MessageProcessingException(string message, Exception innerException, long userId, long groupId, string groupType)
            : base(message, innerException)
        {
            UserId = userId;
            GroupId = groupId;
