...
public partial class IEMessengerDbContext : DbContext
{
    public IEMessengerDbContext()
    {
    }

    public IEMessengerDbContext(DbContextOptions<IEMessengerDbContext> options)
        : base(options)
    {
    }
    ...
    //        => optionsBuilder.UseSqlServer("Server=127.0.0.1,52406;Database=IEMessengerDB;User Id=sa;Password=123;TrustServerCertificate=True;");
